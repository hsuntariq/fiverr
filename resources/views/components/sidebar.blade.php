    ...
    <div class="sidebar translate-nx-100 transition-fast p-3 height-full col-md-4 col-sm-4 bg-white y-scroll">
        ...
        <div class="d-flex align-items-center gap-3">
            <img src="https://images.ctfassets.net/lh3zuq09vnm2/yBDals8aU8RWtb0xLnPkI/19b391bda8f43e16e64d40b55561e5cd/How_tracking_user_behavior_on_your_website_can_improve_customer_experience.png"
                width="80px" alt="user image" class="clip-circle">
            <h6>Username</h6>
        </div>
        <ul class="d-flex text-capitalize my-4 flex-column gap-3 list-unstyled">
            <li class="py-2">Home</li>
            <li class="py-2">inbox</li>
            <li class="py-2">post a project brief</li>
            <li class="py-2">your briefs</li>
            ...
            <li class="fw-bold py-2">
                Buying
            </li>
            <li class="fw-bold py-2 mt-4">
                Selling
            </li>
            <li class=" py-2">
                start selling
